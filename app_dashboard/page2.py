...
def page2_body():
    ...
    if st.checkbox("Difference between average and variability image"):
      ...
      avg_apples = plt.imread(f"outputs/{version}/avg_var_Apple.png")
      avg_oranges = plt.imread(f"outputs/{version}/avg_var_Orange.png")
      ...
      st.image(avg_apples, caption='Apples - Average and Variability')
      st.image(avg_oranges, caption='Oranges - Average and Variability')
      st.write("---")

    if st.checkbox("Differences between average apple and average orange"):
